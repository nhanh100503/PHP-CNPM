<html>
    <?php 
        ...
        $sql = "
                ...
                hv.ngay_sinh, hv.so_dien_thoai, hv.can_cuoc_cong_dan, hv.email,
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <?php foreach($rows as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_register.php?id=<?= $row['dang_ky_id'] ?>">Sửa</a>
                                <a href="delete_register.php?id=<?= $row['dang_ky_id'] ?>" onclick="return confirm('Chắc chắn xóa?')">Xóa</a>
                            </td>
                            <td>
                                <input type="checkbox" name="selected_ids[]" value="<?= $row['dang_ky_id'] ?>">
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="12">Không có học viên đăng ký</td>
                    </tr>
                <?php endif; ?> 
            </table>
        </form>
