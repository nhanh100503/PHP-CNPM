<?php
    ...
    $khoa_hoc = "INSERT INTO khoa_hoc (ma_khoa_hoc, ten_khoa_hoc, ngay_bat_dau, ngay_ket_thuc, hoc_phi)
                 VALUES ('DI001', 'Lập trình PHP', '2025-09-01', '2025-12-30', 2000000),
                        ('DI002', 'Lập trình Java', '2025-09-01', '2025-12-30', 2500000),
                        ('DI003', 'Lập trình Python', '2025-09-01', '2025-12-30', 3000000)";
